...
.wave {
  ...
  animation-timing-function: cubic-bezier(0.76, 1.63, 0.68, 0.79);
}
.umbrella {
  width: 24%;
  right: 15%;
...
.summer {
  ...
  animation-timing-function: cubic-bezier(0.18, 1.87, 0.6, 0.66);
}
.ball {
  width: 10%;
  bottom: 35%;
